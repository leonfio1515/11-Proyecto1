...
var url_import_finan = "../../admin/AdministracionApp/docfinancieras/import/"
var minDate, maxDate;
...
/***************************************************************/   
    var table = $('#tabla').DataTable({
        ...
        buttons:[
            ...
            titleAttr: 'Importar documentos',
            className: 'btn btn-primary',
            action: function () {
                window.location.href = url_import_finan;
        }},
...
/***************************************************************/    
    ...
    $('.btnEdit').on('click', function () {
        ...
        $('input[name="fecha_doc"]').val(data[3]);
        $('input[name="codigo"]').val(data[6]);
        $('input[name="tipo_doc"]').val(data[7]);
        $('input[name="num_doc"]').val(data[8]);
