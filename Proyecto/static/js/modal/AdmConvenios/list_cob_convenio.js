...
/***************************************************************/    
    ...
    $('.btnEdit').on('click', function () {
        ...
        $('select[name="mes_cobro"]').val(data[13]);
        $('input[name="nombre_empresa"]').val(data[15]);
        $('select[name="mes_resumen"]').val(data[14]);
        $('input[name="imp_resumen"]').val(data[7]);
        $('input[name="imp_bonificacion"]').val(parseFloat(data[8]));
        $('input[name="imp_cobrar"]').val(parseFloat(data[16]));
