...
/***************************************************************/    
    ...
    $('.btnEdit').on('click', function () {
        ...
        $('input[name="sucursal"]').val(data[5]);
        $('input[name="fecha_error"]').val(data[6]);
        $('input[name="num_cajera"]').val(data[7]);
        $('input[name="num_boleta"]').val(data[8]);
        $('input[name="grupo"]').val(data[9]);
        $('textarea[name="comentario"]').val(data[10]);
