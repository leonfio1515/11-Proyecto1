...
/***************************************************************/    
    ...
    $('.btnEdit').on('click', function () {
        ...
        $('input[name="medio_promo"]').val(data[3]);
        $('input[name="valor_promo"]').val(data[4]);
        $('input[name="descripcion_promo"]').val(data[5]);
        $('input[name="fecha_inicio"]').val(data[6]);
        $('input[name="fecha_fin"]').val(data[7]);
        $('input[name="alcance_promo"]').val(data[8]);
